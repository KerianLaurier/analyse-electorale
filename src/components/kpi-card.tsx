...
/**
 * Carte d'indicateur clé (libellé + valeur + précision facultative). Style
 * partagé par les vues Analyser. `accent` colore la valeur :
 * `positive` (vert), `negative`/`over` (rouge), `under` (bleu).
 */
