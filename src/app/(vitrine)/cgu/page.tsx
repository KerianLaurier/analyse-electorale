  ...
  return (
    <LegalShell title="Conditions générales d'utilisation et d'abonnement" updated="21 juillet 2026">
      ...
      <p>
        ...
        <Todo>raison sociale</Todo> (voir <Link href="/mentions-legales">mentions légales</Link>). Toute
      ...
      <p>
        ...
        <Link href="/confidentialite">politique de confidentialité</Link>). Toute tentative d&apos;atteinte
